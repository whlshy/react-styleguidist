 ...
 */
var RandomButton = /*#__PURE__*/function (_Component) {
  _inherits(RandomButton, _Component);

  var _super = _createSuper(RandomButton);
  ...
  function RandomButton(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function () {
      _this.setState({
        label: (0, _sample.default)(_this.props.variants)
      });
    });

    _this.state = {
      label: (0, _sample.default)(props.variants)
    };
    return _this;
  }
...
_defineProperty(RandomButton, "propTypes", {
  /**
